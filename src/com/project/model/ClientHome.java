...
public class ClientHome {
	...
	public Client findById(java.math.BigDecimal id) {
		log.debug("getting Client instance with id: " + id);
		try {
			Client instance = (Client) sessionFactory.getCurrentSession().get("com.project.model.Client", id);
			if (instance == null) {
	...
	public List findByExample(Client instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.project.model.Client")
